...
var tests = {
    ...
    testAuditSettings: function(){
        var a = fsr.setconsole.log("10d","","/tmp/a/b/c/files/%DATE%/logs");
        console.log(a)
        ...
        a = fsr.setconsole.log("10","/tmp/a/b/log_audit_file.json","/tmp/a/b/c/files/%DATE%/logs1");
        console.log(a)
        ...
        // var b = fsr.writeconsole.log({keep:{days:true,amount:10},auditLog: "/tmp/aa/a/e/a/b/c/a/b/b/ba_log.json",files:[{date:Date.now(), name:"/tmp/a/b/c.log"}]});
