...
const mailerSend = new MailerSend({
  apiKey: APP_CONFIG.MAILERSEND_API_KEY,
});
...
const emailService = {
    ...
    try {
      ...
      const personalization = [
        {
          ...
          data: {
            ...
            support_email: "buildlab94@gmail.com",
      ...
      const emailParams = new EmailParams()
        ...
        .setTemplateId("z3m5jgryzrd4dpyo")
  ...
  sendPasswordResetEmail: async (email, token, resetUrl) => {
    ...
    const emailParams = new EmailParams()
      .setFrom(sentFrom)
      .setTo(recipients)
      .setSubject("Reset Your Password - Buildlab")
      .setText(`
        Reset Your Password
  ...
  sendEmailUpdateConfirmation: async (oldEmail, newEmail) => {
    const recipients = [new Recipient(oldEmail)];

    const emailParams = new EmailParams()
      .setFrom(sentFrom)
      .setTo(recipients)
      .setSubject("Email Address Updated - Buildlab")
      .setText(`
...
//     const mailOptions = {
//       from: `"BuildLab Team" <noreply@thebuildlab.app>`,
//       to: email,
